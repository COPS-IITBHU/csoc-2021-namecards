const CONTRIBUTERS = [
    ...
    {
        handle_name: 'Pratik01-git',
        name: "Pratik Kumar Soni",
        image: "https://images.pexels.com/photos/276514/pexels-photo-276514.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
        description: `
            <script src="https://cdn.lordicon.com//libs/frhvbuzj/lord-icon-2.0.2.js"></script>
            <div class="text-center">
                <lord-icon src="https://cdn.lordicon.com//gmzxduhd.json" trigger="loop" colors="primary:#121331,secondary:#08a88a" style="width:25px;height:25px"></lord-icon> 
        ...
        `,
        github: "https://github.com/Pratik01-git",
    },
];
