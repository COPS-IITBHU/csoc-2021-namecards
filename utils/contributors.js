const CONTRIBUTERS = [
    ...
    {
        handle_name: 'ramalik00',
        name: "Rahul Malik",
        image: "/images/rahul.jpg",
        description: `
            <script src="https://cdn.lordicon.com//libs/frhvbuzj/lord-icon-2.0.2.js"></script>
            <div class="text-center">
                <lord-icon src="https://cdn.lordicon.com//vieswnpa.json" trigger="loop" colors="primary:#121331,secondary:#08a88a" style="width:35px;height:35px"></lord-icon>
                    Music
                <lord-icon src="https://cdn.lordicon.com//vieswnpa.json" trigger="loop" colors="primary:#121331,secondary:#08a88a" style="width:35px;height:35px"></lord-icon>
                <br />
                <lord-icon src="https://cdn.lordicon.com//ktxpktdd.json" trigger="loop" colors="primary:#121331,secondary:#08a88a" style="width:35px;height:35px"></lord-icon> 
                    Gaming
                <lord-icon src="https://cdn.lordicon.com//ktxpktdd.json" trigger="loop" colors="primary:#121331,secondary:#08a88a" style="width:35px;height:35px"></lord-icon>
                <br />
                <lord-icon src="https://cdn.lordicon.com//szzsfswk.json" trigger="loop" colors="primary:#121331,secondary:#08a88a" style="width:35px;height:35px"></lord-icon> 
                    Eating
                <lord-icon src="https://cdn.lordicon.com//szzsfswk.json" trigger="loop" colors="primary:#121331,secondary:#08a88a" style="width:35px;height:35px"></lord-icon>
            </div>
        `,
        github: "https://github.com/ramalik00",
    },
