    ...
    },
    {
        ...
        description: `
            ...
            <div class="text-center">
                ...
                <lord-icon src="https://cdn.lordicon.com//anihkfxp.json" trigger="loop" colors="primary:#121331,secondary:#08a88a" style="width:25px;height:25px"></lord-icon>
                <br />
                <lord-icon src="https://cdn.lordicon.com//qhgmphtg.json" trigger="loop" colors="primary:#121331,secondary:#08a88a" style="width:25px;height:25px"></lord-icon> 
                    Exploring
                <lord-icon src="https://cdn.lordicon.com//qhgmphtg.json" trigger="loop" colors="primary:#121331,secondary:#08a88a" style="width:25px;height:25px"></lord-icon>
                <br />
                <lord-icon src="https://cdn.lordicon.com//ktxpktdd.json" trigger="loop" colors="primary:#121331,secondary:#08a88a" style="width:25px;height:25px"></lord-icon> 
                    Gaming
                <lord-icon src="https://cdn.lordicon.com//ktxpktdd.json" trigger="loop" colors="primary:#121331,secondary:#08a88a" style="width:25px;height:25px"></lord-icon>
                <br />
        ...
        `,
        github: "https://github.com/try-catch-stack",
    },
];
