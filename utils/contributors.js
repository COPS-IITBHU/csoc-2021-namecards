const CONTRIBUTERS = [
...

    {
        ...
        description: `
            ...
            <div class="text-center">
                <lord-icon src="https://cdn.lordicon.com//ptbbcteb.json" trigger="loop" colors="primary:#121331,secondary:#08a88a" style="width:25px;height:25px"></lord-icon> 
                    Coding
                <lord-icon src="https://cdn.lordicon.com//bkqtuigh.json" trigger="loop" colors="primary:#121331,secondary:#08a88a" style="width:25px;height:25px"></lord-icon>
                <br />
        ...
        `,
        github: "https://github.com/spandanhalder",
    },
];
